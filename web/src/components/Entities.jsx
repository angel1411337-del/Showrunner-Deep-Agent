...
export function Entities({ events, relationships, obligations }) {
                    ...
                    {entities.map((entity) => {
                        ...
                        return (
                            <div
                                ...
                                className="glass-panel p-4 rounded-xl space-y-3 hover:bg-white/10 transition-all border border-white/5 hover:border-white/20 group cursor-pointer"
                            >
